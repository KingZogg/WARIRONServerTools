...
set dbpass=-Kwob@7mHQ

:: Error log path - Important in debugging your issues
set errorLogPath="C:\Arma3ServerTools\MySQLBackups\backupfiles\dumperrors.txt"

:: MySQL EXE Path
set mysqldumpexe="C:\Program Files (x86)\MySQL\MySQL Server 5.6\bin\mysqldump.exe"

:: Error log path
set backupfldr="C:\Arma3ServerTools\MySQLBackups\backupfiles\

:: Path to data folder which may differ from install dir
set datafldr="C:\ProgramData\MySQL\MySQL Server 5.6\data\"

:: Path to zip executable
set zipper="C:\Arma3ServerTools\MySQLBackups\zip\7za.exe"
...
echo Skipping DB backup for database that is not a3wasteland
)
)
